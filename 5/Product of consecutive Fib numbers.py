...
# F(n)∗F(n+1)=prod
# Your function takes an integer (prod) and returns an array/tuple (check the function
# signature/sample tests for the return type in your language):
#
# if F(n) * F(n+1) = prod:
# (F(n), F(n+1), true)
...
assert product_fib(714) == [21, 34, True]
assert product_fib(800) == [34, 55, False]
