...
#
# The Haskell version takes a list of directions with data Direction = North | East
# | West | South.
...
#             break
#
#     if len(arr) > 1 and opposites[arr[-2]] == arr[-1]:
#         del arr[-1]
#     return arr
...
def dir_reduc(arr: list[str]) -> list[str]:
    ...
    for direction in arr:
        if res and res[-1] == opposites[direction]:
            res.pop()
        else:
...
assert dir_reduc(["NORTH", "SOUTH", "SOUTH", "EAST", "WEST", "NORTH", "WEST"]) == ['WEST']
assert dir_reduc(["NORTH", "WEST", "SOUTH", "EAST"]) == ["NORTH", "WEST", "SOUTH", "EAST"]
assert dir_reduc(["NORTH","SOUTH","SOUTH","EAST","WEST","NORTH"]) == []
assert dir_reduc(["EAST", "EAST", "WEST", "NORTH", "WEST", "EAST", "EAST", "SOUTH", "NORTH", "WEST"]) == ["EAST", "NORTH"]
